  ...
  return (
    <div className="content">
      <div className="text-white text-center details">
        <div className="w-full border detailInfo p-8">
          ...
          <div className="flex items-start mt-6 text-left">
            <div className="mr-10">
              <p className="active flex items-center Light">Reserve Size</p>
              <p className="text-2xl">$1.08B</p>
            </div>
            <div className="mr-10">
              <p className="active Light">Available Liquidity</p>
              <p className="text-2xl">$8.78M</p>
            </div>
            <div>
              <p className="active mr-10 Light">Utilization Rate</p>
              <p className="text-2xl text-left">99.19%</p>
            </div>
            <div>
              <p className="active Light">Oracle Price</p>
        ...
        <div className="flex items-start justify-between mt-10">
          <div className="boxList border py-8 px-3 text-left">
            ...
            <div className="listBox p-4">
              ...
              <div className="flex items-center py-4 line">
                ...
                <div className="flex items-start">
                  <div className="mx-6">
                    <div className="flex items-center">
                      <span className="text text-sm Light">Total supplied</span>
                      <img
                        className="w-4 ml-1"
                    ...
                    <div className="text text-sm Light">$ 1.08B of $ 2.00B</div>
                  </div>
                  <div className="mr-5">
              ...
              <div className="flex items-center  justify-between mt-5">
                ...
                <div className="listBox w-1/3 p-3 mx-2">
                  <div className="flex items-center">
                    <p className="text text-sm Light">Liquidation threshold</p>
                    <img
                      className="w-4 ml-1"
                      src={require("../../asserts/imgs/tips.png")}
                    />
                ...
                <div className="flex items-start py-4">
                  ...
                  <div className="mr-5">
                    <div className="text text-sm Light mb-2 flex items-center">
                      <span className="text text-sm Light">APY, variable</span>
                      <img
                        className="w-4 ml-1"
                        src={require("../../asserts/imgs/tips.png")}
                      />
            ...
            <div className="listBox p-4 mt-6">
              ...
              <div className="my-5">
                ...
                <div className="text text-sm Light mt-4">
                  ...
                  Dashboard. To learn more about E-Mode and applied restrictions
                  in FAQ or Aave V3 Technical Paper.
                </div>
              </div>
            </div>
            <div className="listBox p-4 mt-6">
          ...
          <div className="boxList text-left">
            ...
            <div className="border p-8 mt-10">
              ...
              <div>
                <div className="flex items-center justify-between listBg p-2 mt-2">
                  <div className="flex items-center">
                    <img
                      className="w-8 mr-2"
